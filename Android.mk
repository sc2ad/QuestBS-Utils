...
LOCAL_SRC_FILES := extern/libbeatsaber-hook_0_5_9.so
...
LOCAL_SHARED_LIBRARIES += beatsaber-hook_0_5_9
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"0.3.3"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -DID='"bs-utils"' -I'./shared' -I'./extern'
