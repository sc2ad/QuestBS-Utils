...
# Creating prebuilt for dependency: beatsaber-hook - version: 1.0.4
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"0.5.0"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -DID='"bs-utils"' -I'./shared' -I'./extern'
